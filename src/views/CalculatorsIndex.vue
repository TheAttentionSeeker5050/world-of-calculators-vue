...
<template>
    <div id="main-page-wrapper" class="container-sm my-5">
        ...
        <ul>
            <li><a class="fw-semibold text-primary" href="">Calculator 1 (pending)</a></li>
            <li><a class="fw-semibold text-primary" href="">Calculator 2 (pending)</a></li>
            <li><a class="fw-semibold text-primary" href="">Calculator 3 (pending)</a></li>
        </ul>
