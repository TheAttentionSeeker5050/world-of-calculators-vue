        ...
        <form id="calculator-form" class="container-fluid ">
            <div class="row">
                <div class="input-group mb-3 col-md">
                    ...
                    <input type="number" class="form-control" aria-describedby="og-loan-amount">
                </div>
                <div class="input-group mb-3 col-md">
                    <span class="input-group-text" id="og-loan-term">Original loan term</span>
                    <input type="number" class="form-control" aria-describedby="og-loan-term">
                </div>
            </div>
            <div class="row">
                <div class="input-group mb-3 col-md">
                    <span class="input-group-text" id="remaining-loan-term">Remaining loan term</span>
                    <input type="number" class="form-control" placeholder="years" aria-describedby="remaining-loan-term">
                    <input type="number" class="form-control" placeholder="months" aria-describedby="remaining-loan-term">    
                </div>
            </div>
